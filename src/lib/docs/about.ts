...
export const ROLES: Role[] = [
  {
    ...
    highlights: [
      "Built a Chrome extension in React and TypeScript that keeps customer notes in one place, so business managers move faster through their queue and customers stop being asked things they already answered.",
      "Built the frontend for an AI knowledge graph that pulled several enterprise systems into one place, so people could get up to speed on a business domain without hunting for who owned what.",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Led adoption of Material UI and AWS Cloudscape, which cut down how much frontend code got rewritten from project to project.",
